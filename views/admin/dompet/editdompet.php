        ...
        <div class="col-md-12">
          ...
          <div class="box box-primary">
            <div class="box-header with-border">
              <h3 class="box-title"><b>EDIT DATA DOMPET</b></h3>
            </div>
            <!-- /.box-header -->
            <!-- form start -->
            <form role="form" action="<?php echo base_url(); ?>admin/dompet/proseseditdompet" method="post" enctype="multipart/form-data">
              <div class="col-md-12">
                <div class="box-body">
                <div class="form-group">
                  <label for="Id_Dompet">Id Dompet</label>
                  <input type="text" class="form-control" id="Id_Dompet" name="Id_Dompet" value="<?php echo $data[0]->Id_Dompet ?>" readonly="readonly">
                </div>
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" id="Id_Konsumen" name="Id_Konsumen"value="<?php echo $data[0]->Id_Konsumen ?>" readonly="readonly" >
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control"  name="Nominal_Dompet"value="<?php echo $data[0]->Nominal_Dompet ?>" >
                    </div>
