...
<body class="hold-transition skin-blue sidebar-mini">
  <div class="wrapper">
    ...
    <section class="content-header">
     <a href="<?php echo site_url('admin/dompet'); ?>"><button type="submit" class="btn btn-primary"> <- Back</button></a>
    </section>
        ...
        <div class="col-md-12">
          ...
          <div class="box box-primary">
            <div class="box-header with-border">
              <h3 class="box-title"><b>INPUT DATA DOMPET</b></h3>
            </div>
            <!-- /.box-header -->
            <!-- form start -->
            <form role="form" action="<?php echo base_url(); ?>admin/dompet/prosesinputdompet" method="post" enctype="multipart/form-data">
              <div class="col-md-12">
                <div class="box-body">
                <div class="form-group">
                  <?php
                    ...
                    $v = "DMP111";
                    $last_id =0;
                     $dataDompet = $this->session->all_data;
                     foreach ($dataDompet as $data) {
                       $last_id = substr($data->Id_Dompet, 4,3);
                     }
                    $arr = array($v,$last_id+1);
                    $newest_id = implode("", $arr);

                  ?>
                  <label for="Id_Dompet">Id Dompet</label>
                  <input type="text" class="form-control" id="Id_Dompet" name="Id_Dompet" value="<?php echo $newest_id; ?>" readonly>
                </div>
                  ...
                  <select name="Id_Konsumen" class="form-control">
                    ...
                    <?php
                          ...
                          foreach ($dataKonsumen as $data) { //ngabsen data
                            echo "<option value='". $data->Id_Konsumen."'>".$data->Id_Vendor."-". $data->Nama."</option>";
                          }
                      ?>
                ...
                <div class="form-group">
                  <label>Nominal Dompet</label>
                  <input class="form-control" id="Nominal_Dompet" name="Nominal_Dompet" placeholder="Rp.-" required=""></input>
                </div>
                    <!-- /.input group -->
              </div>
              </div>
