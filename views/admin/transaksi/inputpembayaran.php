        ...
        <div class="col-md-12">
          ...
          <div class="box box-primary">
            <div class="box-header with-border">
              <h3 class="box-title"><b>INPUT DATA PEMBAYARAN</b></h3>
            </div>
            <!-- /.box-header -->
            <!-- form start -->
            <form role="form" action="<?php echo base_url(); ?>admin/transaksi/prosesinputpembayaran" method="post" enctype="multipart/form-data">
              <div class="col-md-12">
                <div class="box-body">
                <div class="form-group">
                  <?php
                    ...
                    $last_id =0;
                     ...
                     foreach ($dataPembayaran as $data) {
                       $last_id = substr($data->Id_Pembayaran, 4,3);
                     }
                  ...
                  <input type="text" class="form-control" id="Id_Pembayaran" name="Id_Pembayaran" value="<?php echo $newest_id; ?>" readonly>
                </div>
                  ...
                  <select name="Id_Bank" class="form-control">
                    ...
                    <?php
                          ...
                          foreach ($dataBank as $data) {
                            echo "<option value='". $data->Id_Bank."'>".$data->Id_Bank."-". $data->Nama_Bank."</option>";
                          }
                      ?>
                  ...
                  <select name="Id_Pesanan" class="form-control">
                    ...
                    <?php
                          ...
                          foreach ($dataPesanan as $data) {
                            echo "<option value='". $data->Id_Pesanan."'>".$data->Id_Pesanan."-". $data->Nama."</option>";
                          }
                      ?>
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" id="Total_Tagihan" name="Total_Tagihan" placeholder="Total Tagihan" required>
                </div>
                  ...
                  <div class="input-group date">
                    ...
                    <input type="text" class="form-control pull-right" id="datepicker" name="Tanggal_Pembayaran">
                  </div>
                  <!-- /.input group -->
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control"  name="Waktu_Pembayaran" placeholder="Waktu_Pembayaran">
                    </div>
