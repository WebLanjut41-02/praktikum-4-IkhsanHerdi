        ...
        <div class="col-md-12">
          ...
          <div class="box box-primary">
            <div class="box-header with-border">
              <h3 class="box-title"><b>INPUT DATA BANK</b></h3>
            </div>
            <!-- /.box-header -->
            <!-- form start -->
            <form role="form" action="<?php echo base_url(); ?>admin/bank/prosesinputbank" method="post" enctype="multipart/form-data">
              <div class="col-md-12">
                <div class="box-body">
                <div class="form-group">
                  <?php
                    ...
                    $last_id =0;
                     ...
                     foreach ($dataFeedback as $data) {
                       $last_id = substr($data->Id_Bank, 4,3);
                     }
                  ...
                  <input type="text" class="form-control" id="Id_Feedback" name="Id_Bank" value="<?php echo $newest_id; ?>" readonly>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="form-group">
                    ...
                    <input type="file" class="form-control" id="Foto_Profil_Vendor" name="Logo_Bank" required="">
                  </div>
