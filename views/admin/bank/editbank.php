        ...
        <div class="col-md-12">
          ...
          <div class="box box-primary">
            <div class="box-header with-border">
              <h3 class="box-title"><b>EDIT DATA BANK</b></h3>
            </div>
            <!-- /.box-header -->
            <!-- form start -->
            <form role="form" action="<?php echo base_url(); ?>admin/bank/proseseditbank" method="post" enctype="multipart/form-data">
              <div class="col-md-12">
                <div class="box-body">
                <div class="form-group">
                  <label for="Id_Feedback">Id Bank</label>
                  <input type="text" class="form-control" id="Id_Feedback" name="Id_Bank" value="<?php echo $data[0]->Id_Bank ?>" readonly="readonly">
                </div>

                <div class="form-group">
                  <label for="Id_Konsumen">Nama Bank  </label>
                  <input type="text" class="form-control" id="Id_Konsumen" name="Nama_Bank" value="<?php echo $data[0]->Nama_Bank ?>">
                </div>

                <div class="form-group">
                  <label for="Id_Vendor">No Rekening </label>
                  <input type="text" class="form-control" id="Id_Vendor" name="No_Rekening" value="<?php echo $data[0]->No_Rekening ?>">
                </div>

                <div class="form-group">
                  <label>Deskripsi</label>
                  <textarea class="form-control" rows="3" name="Deskripsi" placeholder="Deskripsi" required=""><?php echo $data[0]->Deskripsi ?></textarea>
                </div>
                ...
                <div class="form-group">
                  ...
                  <br><br>Ubah Foto<br>
                  <input type="hidden" name="Foto_Profil_Lama" value="<?php echo $data[0]->Logo_Bank; ?>">
                  <input type="file" class="form-control" id="Foto_Profil_Vendor" name="Logo_Bank">
                </div>
                <?php //echo $error;?>
