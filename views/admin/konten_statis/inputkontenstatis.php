...
<head>
  <title>INPUT KONTEN STATIS</title>
  <style type="text/css">
    .tombol {
        ...
        <div class="col-md-12">
          ...
          <div class="box box-primary">
            <div class="box-header with-border">
              <h3 class="box-title"><b>INPUT KONTEN STATIS</b></h3>
            </div>
            <!-- /.box-header -->
            <!-- form start -->
            <form role="form" action="<?php echo base_url(); ?>admin/konten_statis/prosesinputkontenstatis" method="post" enctype="multipart/form-data">
              <div class="col-md-12">
                <div class="box-body">
                <div class="form-group">
                  <?php
                    ...
                    $last_id =0;
                     ...
                     foreach ($dataFeedback as $data) {
                       $last_id = substr($data->Id_Konten_Statis, 4,3);
                     }
                  ...
                  <input type="text" class="form-control" id="Id_Feedback" name="Id_Konten_Statis" value="<?php echo $newest_id; ?>" readonly>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="form-group">
                    <label>Konten</label>
                    <textarea class="form-control" rows="3" name="Konten" placeholder="Konten" required=""></textarea>
                  </div>
