<head>
  ...
  <link rel="stylesheet" href="<?php echo base_url('assets/template/back/plugins') ?>/iCheck/all.css">
  <!-- Bootstrap Color Picker -->
  <link rel="stylesheet" href="<?php echo base_url('assets/template/back/bower_components') ?>/bootstrap-colorpicker/dist/css/bootstrap-colorpicker.min.css">
  <!-- Bootstrap time Picker -->
  <link rel="stylesheet" href="<?php echo base_url('assets/template/back/plugins') ?>/timepicker/bootstrap-timepicker.min.css">
  <!-- Select2 -->
