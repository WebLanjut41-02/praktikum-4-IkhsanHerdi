        ...
        <div class="col-md-12">
          ...
          <div class="box box-primary">
            <div class="box-header with-border">
              <h3 class="box-title"><b>INPUT DATA FEEDBACK</b></h3>
            </div>
            <!-- /.box-header -->
            <!-- form start -->
            <form role="form" action="<?php echo base_url(); ?>admin/feedback/prosesinputfeedback" method="post" enctype="multipart/form-data">
              <div class="col-md-12">
                <div class="box-body">
                <div class="form-group">
                  <?php
                    ...
                    $v = "F111";
                    $last_id =0;
                     $dataFeedback = $this->session->all_data2;
                     foreach ($dataFeedback as $data) {
                       $last_id = substr($data->Id_Feedback, 4,3);
                     }
                  ...
                  <input type="text" class="form-control" id="Id_Feedback" name="Id_Feedback" value="<?php echo $newest_id; ?>" readonly>
                </div>
                ...
                <div class="form-group">
                  ...
                  <select name="Id_Vendor" class="form-control">
                    ...
                    <?php
                          ...
                          $dataVendor = $this->session->all_data3;
                          //print_r($dataSiswa);
                ...
                <div class="form-group">
                  ...
                  <div class="form-group">
                    ...
                    <textarea class="form-control" rows="3" name="Komentar" placeholder="Komentar" required=""></textarea>
                  </div>

                   <div class="form-group">
                        <label>Rating (1-5)</label>
                        <input type="number" class="form-control"  name="Rating" max="5" min="1" placeholder="Rating">
                    </div>
                    <!-- /.input group -->
              </div>
              </div>
