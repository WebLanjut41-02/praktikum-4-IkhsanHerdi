...
<head>
  <title>PENARIKAN DEPOSIT VENDOR</title>
  <style type="text/css">
    .tombol {
        ...
        <div class="col-md-12">
          ...
          <div class="box box-primary">
            <div class="box-header with-border">
              <h3 class="box-title"><b>PENARIKAN DEPOSIT VENDOR</b></h3>
            </div>
            <!-- /.box-header -->
            <!-- form start -->
            <form role="form" action="<?php echo base_url(); ?>admin/depositvendor/prosestarikdepositvendor" method="post" enctype="multipart/form-data">
              <div class="col-md-6">
                ...
                <?php
                    ...
                    $v = "T111";
                    $last_id =0;
                     $dataPdeposit = $this->session->all_data1;
                     foreach ($dataPdeposit as $data) {
                       $last_id = substr($data->Id_Penarikan_Deposit, 4,1);
                     }
                  ...
                  ?>
                <div class="form-group">
                  <label for="Id_Vendor">Id Penarikan Deposit</label>
                  <input type="text" class="form-control" id="Id_Vendor" name="Id_Penarikan" value="<?php echo $newest_id; ?>"  readonly>
                </div>
