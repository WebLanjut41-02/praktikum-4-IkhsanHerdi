...
<head>
  <title>PENAMBAHAN DEPOSIT VENDOR</title>
  <style type="text/css">
    .tombol {
        ...
        <div class="col-md-12">
          ...
          <div class="box box-primary">
            <div class="box-header with-border">
              <h3 class="box-title"><b>PENAMBAHAN DEPOSIT VENDOR</b></h3>
            </div>
            <!-- /.box-header -->
            <!-- form start -->
            <form role="form" action="<?php echo base_url(); ?>admin/depositvendor/prosestambahdepositvendor" method="post" enctype="multipart/form-data">
              <div class="col-md-6">
                <div class="form-group">
                  <label>Id Deposit</label>
                  <input type="text" class="form-control" id="Id_deposit" name="Id_deposit" value="<?php  echo $data[0]->Id_Deposit; ?>" readonly>
                </div>
                
                <div class="form-group">
                  <label>Deposit saat ini</label>
                  <input type="number" class="form-control" id="Nominal" name="Nominal_saat_ini"  value="<?php  echo $data[0]->Nominal_Deposit; ?>" readonly>
                </div>
                ...
                <?php
                    ...
                    $v = "P111";
                    $last_id =0;
                     $dataTdeposit = $this->session->all_data1;
                     foreach ($dataTdeposit as $data) {
                       $last_id = substr($data->Id_Penambahan_Deposit, 4,1);
                     }
                  ...
                  ?>
                <div class="form-group">
                  <label for="Id_Vendor">Id Penambahan Deposit</label>
                  <input type="text" class="form-control" id="Id_Vendor" name="Id_Penambahan" value="<?php echo $newest_id; ?>"  readonly>
                </div>
