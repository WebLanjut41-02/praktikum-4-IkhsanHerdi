...
<head>
  <title>INPUT DEPOSIT VENDOR</title>
  <style type="text/css">
    .tombol {
        ...
        <div class="col-md-12">
          ...
          <div class="box box-primary">
            <div class="box-header with-border">
              <h3 class="box-title"><b>INPUT DEPOSIT VENDOR</b></h3>
            </div>
            <!-- /.box-header -->
            <!-- form start -->
            <form role="form" action="<?php echo base_url(); ?>admin/depositvendor/prosesinputdepositvendor" method="post" enctype="multipart/form-data">
              <div class="col-md-6">
                <div class="box-body">
                <div class="form-group">
                  <?php
                    $i = 1;
                    $v = "D111";
                     $datadepositVendor = $this->session->all_data;
                     if (count($datadepositVendor)<=0) {

                        $newest_id = "D1111";
                     }else {
                        foreach ($datadepositVendor as $data) {
                            $last_id = substr($data->Id_Deposit, 4,3);
                          }
                  ...
                  <input type="text" class="form-control" id="Id_Vendor" name="Id_Vendor" value="<?php echo $dataid[0]->Id_Vendor ?>"  readonly>
                </div>

                <div class="form-group">
                  <label>Id Deposit</label>
                  <input type="text" class="form-control" id="Id_deposit" name="Id_deposit" value="<?php echo $newest_id; ?>"  placeholder="Id deposit" required>
                </div>
