...
<body class="hold-transition skin-blue sidebar-mini">
  <div class="wrapper">
    ...
    <section class="content-header">
     <a href="<?php echo site_url('admin/kurir'); ?>"><button type="submit" class="btn btn-primary"> <- Back</button></a>
    </section>
        ...
        <div class="col-md-12">
          ...
          <div class="box box-primary">
            <div class="box-header with-border">
              <h3 class="box-title"><b>INPUT DATA KURIR</b></h3>
            </div>
            <!-- /.box-header -->
            <!-- form start -->
            <form role="form" action="<?php echo base_url(); ?>admin/kurir/prosesinputkurir" method="post" enctype="multipart/form-data">
              <div class="col-md-12">
                <div class="box-body">
                <div class="form-group">
                  <?php
                    ...
                    $v = "K111";
                    $last_id =0;
                     $dataKurir = $this->session->all_data;
                     foreach ($dataKurir as $data) {
                       $last_id = substr($data->Id_Kurir, 4,3);
                     }
                  ...
                  <input type="text" class="form-control" id="Id_Kurir" name="Id_Kurir" value="<?php echo $newest_id; ?>" readonly>
                </div>
                ...
                <div class="form-group">
                  ...
                  <input class="form-control" id="Nama_Kurir" name="Nama_Kurir" placeholder="Nama Kurir" required=""></input>
                </div>

                <div class="form-group">

                  <div class="form-group">
                    <label>No Telfon Kurir</label>
                    <input class="form-control" id="No_Telfon_Kurir" name="No_Telfon_Kurir" placeholder="No Telfon Kurir" required=""></input>
                  </div>
                    <!-- /.input group -->
              </div>
              </div>
