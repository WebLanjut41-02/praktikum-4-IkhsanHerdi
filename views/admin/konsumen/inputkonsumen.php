        ...
        <div class="col-md-12">
          ...
          <div class="box box-primary">
            <div class="box-header with-border">
              <h3 class="box-title"><b>INPUT DATA KONSUMEN</b></h3>
            </div>
            <!-- /.box-header -->
            <!-- form start -->
            <form role="form" action="<?php echo base_url(); ?>admin/konsumen/prosesinputkonsumen" method="post" enctype="multipart/form-data">
              <div class="col-md-12">
                <div class="box-body">
                <div class="form-group">
                  <?php
                    ...
                    $last_id =0;
                     ...
                     foreach ($dataKonsumen as $data) {
                       $last_id = substr($data->Id_Konsumen, 4,3);
                     }
                  ...
                  <input type="text" class="form-control" id="Id_Konsumen" name="Id_Konsumen" value="<?php echo $newest_id; ?>" readonly>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control"  name="No_Telfon_Konsumen" placeholder="No. Tlp. Konsumen">
                    </div>
                ...
                <div class="form-group">
                  <label>Foto Profil Konsumen</label>
