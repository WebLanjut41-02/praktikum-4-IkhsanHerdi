...
<body class="hold-transition skin-blue sidebar-mini">
  <div class="wrapper">
    ...
    <section class="content-header">
     <a href="<?php echo site_url('admin/konsumen'); ?>"><button type="submit" class="btn btn-primary"> <- Back</button></a>
    </section>
        ...
        <div class="col-md-12">
          ...
          <div class="box box-primary">
            <div class="box-header with-border">
              <h3 class="box-title"><b>EDIT DATA KONSUMEN</b></h3>
            </div>
            <!-- /.box-header -->
            <!-- form start -->
            <form role="form" action="<?php echo base_url(); ?>admin/konsumen/proseseditkonsumen" method="post" enctype="multipart/form-data">
              <div class="col-md-12">
                <div class="box-body">
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" id="Nama_Konsumen" name="Nama_Konsumen"value="<?php echo $data[0]->Nama ?>" >
                </div>
              
                <div class="form-group">
               
                    <div class="form-group">
                      <label>No. Tlp Konsumen</label>
                      <input type="text" class="form-control"  name="No_Telfon_Konsumen"value="<?php echo $data[0]->No_Telfon ?>" >
                    </div>
                ...
                <div class="form-group">
                  ...
                  <br><br>Ubah Foto<br>
                  <input type="hidden" name="Foto_Profil_Lama" value="<?php echo $data[0]->Foto_Profil; ?>">
