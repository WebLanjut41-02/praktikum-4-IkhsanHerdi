        ...
        <div class="col-md-12">
          ...
          <div class="box box-primary">
            <div class="box-header with-border">
              <h3 class="box-title"><b>EDIT DATA MENU</b></h3>
            </div>
            <!-- /.box-header -->
            <!-- form start -->
            <form role="form" action="<?php echo base_url(); ?>admin/menu/proseseditmenu" method="post" enctype="multipart/form-data">
              <div class="col-md-12">
                <div class="box-body">
                <div class="form-group">
                  <label for="Id_Paket">Id Paket</label>
                  <input type="text" class="form-control" id="Id_Paket" name="Id_Paket" value="<?php echo $data[0]->Id_Paket ?>" readonly="readonly">
                </div>

                <div class="form-group">
                  <label>Nama Paket</label>
                  <input type="text" class="form-control" id="Nama_Paket" name="Nama_Paket"value="<?php echo $data[0]->Nama_Paket ?>" >
                </div>
                
                <?php echo form_open_multipart('upload/do_upload');?>
                <div class="form-group">
                  <label>Gambar Paket </label><br>
                  <?php if(isset($data[0]->Gambar_Paket))echo "<img src='".base_url(substr($data[0]->Gambar_Paket, 32))."' width='150' height='150'>"; else echo "Masih Kosong"; ?>
                  <br><br>Ubah Foto<br>
                  <input type="hidden" name="Foto_Profil_Lama" value="<?php echo $data[0]->Gambar_Paket; ?>">
                  <input type="file" class="form-control" id="Foto_Profil_Vendor" name="Gambar_Paket">
                </div>

                <div class="form-group">
                  <label>Harga_Paket</label>
                  <input type="text" class="form-control" id="Harga_Paket" name="Harga_Paket"value="<?php echo $data[0]->Harga_Paket ?>" >
                </div>

                <div class="form-group">
                  <label>Deskripsi_Paket</label>
                  <input type="text" class="form-control" id="Deskripsi_Paket" name="Deskripsi_Paket"value="<?php echo $data[0]->Deskripsi_Paket ?>" >
                </div>

                <div class="form-group">
                  <label>Kategori_Paket</label>
                  <input type="text" class="form-control" id="Kategori_Paket" name="Kategori_Paket"value="<?php echo $data[0]->Kategori_Paket ?>" >
                </div>

                <div class="form-group">
                  <label for="Id_Vendor">Id Vendor</label>
                  <input type="text" class="form-control" id="Id_Vendor" name="Id_Vendor" value="<?php echo $data[0]->Id_Vendor ?>" readonly="readonly">
                </div>
                <?php //echo $error;?>
