        ...
        <div class="col-md-12">
          ...
          <div class="box box-primary">
            <div class="box-header with-border">
              <h3 class="box-title"><b>INPUT DATA BANNER</b></h3>
            </div>
            <!-- /.box-header -->
            <!-- form start -->
            <form role="form" action="<?php echo base_url(); ?>admin/banner/prosesinputbanner" method="post" enctype="multipart/form-data">
              <div class="col-md-12">
                <div class="box-body">
                <div class="form-group">
                  <?php
                    ...
                    $v = "BN11";
                    $last_id =0;
                     $dataFeedback = $this->session->all_data;
                     foreach ($dataFeedback as $data) {
                       $last_id = substr($data->Id_Banner, 4,3);
                     }
                  ...
                  <input type="text" class="form-control" id="Id_Feedback" name="Id_Banner" value="<?php echo $newest_id; ?>" readonly>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="form-group">
                       ...
                       <input type="text" class="form-control"  name="Nama_Banner" placeholder="Nama Banner">
                   </div>
                  ...
                  <div class="form-group">
                    ...
                    <input type="file" class="form-control" id="Foto_Profil_Vendor" name="Banner" required="">
                  </div>
