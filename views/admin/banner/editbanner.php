        ...
        <div class="col-md-12">
          ...
          <div class="box box-primary">
            <div class="box-header with-border">
              <h3 class="box-title"><b>EDIT DATA BANNER</b></h3>
            </div>
            <!-- /.box-header -->
            <!-- form start -->
            <form role="form" action="<?php echo base_url(); ?>admin/banner/proseseditbanner" method="post" enctype="multipart/form-data">
              <div class="col-md-12">
                <div class="box-body">
                <div class="form-group">
                  <label for="Id_Feedback">Id Banner</label>
                  <input type="text" class="form-control" id="Id_Feedback" name="Id_Banner" value="<?php echo $data[0]->Id_Banner ?>" readonly="readonly">
                </div>

                <div class="form-group">
                  <label for="Id_Konsumen">Nama Banner  </label>
                  <input type="text" class="form-control" id="Id_Konsumen" name="Nama_Banner" value="<?php echo $data[0]->Nama_Banner ?>">
                </div>

                <div class="form-group">
              <label for="nip">Status</label>
              <select name="Status" class="form-control">
                <option value='Enable' <?php if ($data[0]->Status == 'Enable') {echo "selected";} ?>>Enable</option>
                <option value='Disable' <?php if ($data[0]->Status == 'Disable') {echo "selected";} ?>>Disable</option>
              </select>
            </div>
                ...
                <div class="form-group">
                  ...
                  <br><br>Ubah Foto<br>
                  <input type="hidden" name="Foto_Profil_Lama" value="<?php echo $data[0]->Banner; ?>">
                  <input type="file" class="form-control" id="Foto_Profil_Vendor" name="Banner">
                </div>
                <?php //echo $error;?>
